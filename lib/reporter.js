  ...
  this.fn = function(results, done) {
    ...
    var generate = function generate(next) {
      ...
      async.waterfall([
        ...
        var hasFailure = (typeof results.failed !== 'undefined' && results.failed !== 0)
          || (typeof results.errors  !== 'undefined' && results.errors  !== 0);

        if ((opts.openBrowser && !opts.openBrowserOnlyOnFailure) || (opts.openBrowserOnlyOnFailure && hasFailure))
          open(reportFilename);
